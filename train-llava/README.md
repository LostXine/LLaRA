...
This section of our project builds upon code originally from [LLaVA](https://github.com/haotian-liu/LLaVA). We have adapted specific files to accommodate our custom-generated datasets. Both the original LLaVA project and this modified component are released under the Apache-2.0 license.
...
## Original LLaVA README
Below is the original README from the LLaVA project:
